		        ...
		        <ul class="nav navbar-nav nav_1">
		            ...
		            <li class="dropdown">
		              ...
		              <ul class="dropdown-menu" role="menu">
		                ...
		                <li><a href="#">Manage Horoscope</a></li>
		                <li><a href="#">Manage Photos</a></li>
		                <li><a href="#">Membership</a></li>
		                <li><a href="#">Orders</a></li>
		                <li><a href="#">Photo Requests</a></li>
					...
					<li class="dropdown">
		              ...
		              <ul class="dropdown-menu" role="menu">
		                ...
		                <li><a href="faq.html">Education Search</a></li>
		                <li><a href="shortcodes.html">Occupation Search</a></li>
		                <li><a href="shortcodes.html">Horoscope Search</a></li>
		              </ul>
		            </li>
		            <!--<li class="dropdown">
